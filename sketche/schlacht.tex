...
\end{verseplay}
\regie{Youtube-Video mit ``Dieses Video ist in Mittelerde nicht verfügbar''.}
...
\regie{Die Schlacht geht los. Monk monkt rum. Der Rest ignoriert Monk und kämpft. Dann wird ``Währenddessen auf der Brücke des ''Todessterns`` gezeigt. Der Rest wird während der Probe entschieden. Zum Schluß gehen sie durch eine Tür mit der Aufschrift ''Druckerraum`` oder so.}
